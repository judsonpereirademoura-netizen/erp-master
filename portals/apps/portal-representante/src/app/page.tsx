  ...
  return (
    <main style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column',gap:'1rem'}}>
      <div style={{textAlign:'center',padding:'2rem'}}>
        <h1 style={{fontSize:'1.5rem',fontWeight:'700',color:'#1e40af',margin:'0 0 0.5rem'}}>Portal do Representante</h1>
        <p style={{color:'#64748b',margin:'0 0 0.25rem'}}>Master Rótulos e Etiquetas</p>
        <p style={{color:'#94a3b8',fontSize:'0.875rem',margin:'0 0 2rem'}}>representante.masteretiquetas.com</p>
